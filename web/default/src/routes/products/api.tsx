...
function ProductsApi() {
  return (
    <ProductsLayout>
      {/* ── Hero ── */}
      <div style={{ borderRadius: 0, margin: '0 -24px', padding: '80px 60px', textAlign: 'center', marginBottom: 0, position: 'relative', overflow: 'hidden', background: '#001840' }}>
      ...
      {/* ── Core Features ── */}
      <div style={{ margin: '80px -24px 0', padding: '80px 48px', background: `${BRAND.light}`, borderTop: `1px solid ${BRAND.border}`, borderBottom: `1px solid ${BRAND.border}` }}>
      ...
      {/* ── CTA ── */}
      <div style={{ margin: '80px -24px 0', background: 'linear-gradient(135deg, #004A8F 0%, #002060 100%)', borderRadius: 0, margin: '0 -24px', padding: '64px 48px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
