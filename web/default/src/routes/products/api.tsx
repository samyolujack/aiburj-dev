...
function ProductsApi() {
  return (
    <ProductsLayout>
      ...
      <div style={{ background: 'linear-gradient(135deg, #004A8F 0%, #002060 40%, #001840 100%)', borderRadius: 20, padding: '80px 60px', textAlign: 'center', marginBottom: 0, position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Core Features — muted background with border */}
      <div style={{ margin: '0 -48px', padding: '80px 48px', background: `${BRAND.light}`, borderTop: `1px solid ${BRAND.border}`, borderBottom: `1px solid ${BRAND.border}` }}>
      ...
      {/* Use Scenarios — white background */}
      ...
      {/* CTA — dark blue gradient, full-width */}
      <div style={{ margin: '0 -48px', background: 'linear-gradient(135deg, #004A8F 0%, #002060 100%)', borderRadius: 0, padding: '64px 48px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
