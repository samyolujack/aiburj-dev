...
/* ── Hero 轮播数据 ── */
const slides = [
  { title: t('国产大模型的灯塔'), title2: t('一站汇聚，照亮 AI 之路'), desc: t('OpenAI 兼容格式，统一 API 调用 DeepSeek、通义千问、GLM 等国产大模型，按量计费，快速集成'), bg: '/banner-1.png', overlay: 'linear-gradient(180deg, rgba(230,240,250,0.55) 0%, rgba(220,235,248,0.65) 50%, rgba(255,255,255,0.9) 100%)', textColor: '#252736', badge: t('AI 之塔'), isDark: false },
  { title: t('覆盖 8 大国产厂商'), title2: t('16 款主流模型'), desc: t('DeepSeek V4、Qwen3、GLM-5.1、Kimi-K2 等最新旗舰模型，一次接入全部调用'), bg: '/banner-2.png', overlay: 'linear-gradient(180deg, rgba(230,240,250,0.55) 0%, rgba(220,235,248,0.65) 50%, rgba(255,255,255,0.9) 100%)', textColor: '#252736', badge: t('模型生态'), isDark: false },
  { title: t('比官方更优的价格'), title2: t('按量计费无门槛'), desc: t('新人注册即享体验额度，支持高速推理通道，99.9% 服务可用性保障'), bg: '/banner-3.png', overlay: 'linear-gradient(180deg, rgba(230,240,250,0.55) 0%, rgba(220,235,248,0.65) 50%, rgba(255,255,255,0.9) 100%)', textColor: '#252736', badge: t('高性价比'), isDark: false },
  { title: t('三步接入零门槛'), title2: t('一行代码调用大模型'), desc: t('获取 API Key → 选择模型 → 复制代码，OpenAI SDK 直接兼容，5 分钟完成集成'), bg: '/banner-4.png', overlay: 'linear-gradient(180deg, rgba(230,240,250,0.55) 0%, rgba(220,235,248,0.65) 50%, rgba(255,255,255,0.9) 100%)', textColor: '#252736', badge: t('极速接入'), isDark: false },
  { title: t('企业级安全合规'), title2: t('数据隐私全面保障'), desc: t('支持私有化部署，计算隔离/网络隔离/存储隔离，符合行业安全标准与合规要求'), bg: '/banner-5.png', overlay: 'linear-gradient(180deg, rgba(230,240,250,0.55) 0%, rgba(220,235,248,0.65) 50%, rgba(255,255,255,0.9) 100%)', textColor: '#252736', badge: t('安全可靠'), isDark: false },
]

/* ── 产品矩阵数据 ── */
const productCards = [
  { title: t('开箱即用的大模型 API'), desc: t('覆盖语言、语音、图片、视频等场景，一站式提供大模型 API 服务，按量计费，助力应用快速上线。'), img: '/product-api.png', tag: t('API 服务'), href: '/pricing' },
  { title: t('高效能模型推理加速'), desc: t('自研推理加速引擎，无论是自研模型还是开源模型，均可接入高效推理加速服务，全面提升响应速度与处理性能。'), img: '/product-speed.png', tag: t('推理加速'), href: '/pricing' },
  { title: t('按量计费 + 企业级保障'), desc: t('无月费无门槛，按实际 Token 用量计费。提供企业级 SLA 保障，99.9% 服务可用性，新用户注册即享体验额度。'), img: '/product-billing.png', tag: t('灵活计费'), href: '/pricing' },
  { title: t('专属预留实例'), desc: t('面向企业核心推理场景，提供独占算力、精度保障与成本优化的一站式方案，支撑关键业务稳定运行。'), img: '/product-reserved.png', tag: t('企业方案'), href: '/pricing' },
  { title: t('私有化部署'), desc: t('提供企业级私有化部署方案，一站式解决模型性能优化、部署与运维等痛点，满足多样化场景需求。'), img: '/product-private.png', tag: t('私有部署'), href: '/pricing' },
  { title: t('多模态 AI 服务'), desc: t('整合视觉理解、语音识别、视频生成等多模态能力，统一 API 调用，覆盖内容创作、智能客服、实时互动等场景。'), img: '/product-multimodal.png', tag: t('多模态'), href: '/pricing' },
]

/* ── 性能指标 ── */
const perfCards = [
  { value: '16+', label: t('主流模型'), desc: t('覆盖语言、视觉、语音'), icon: Cpu },
  { value: '8', label: t('国产厂商'), desc: t('深度合作持续接入'), icon: Globe },
  { value: '99.9%', label: t('服务可用性'), desc: t('企业级 SLA 保障'), icon: Shield },
  { value: '100%', label: t('国产模型'), desc: t('全场景国产覆盖'), icon: Zap },
]

/* ── 核心优势大卡 ── */
const bigCards = [
  {
    title: t('高速推理'), bg: "url('/deco-speed-bg.png') center/cover no-repeat{t(",
    textColor: '#FAFDFF', borderColor: '#0080C0',
    shadowHover: '0 24px 70px rgba(0,42,96,0.30)',
    sections: [
      { value: '10x+', label: t('推理速度提升') },
      { value: '3x+', label: t('生图模型加速') },
      { value: '100ms', label: t('语音生成延迟') },
    ],
  },
  {
    title: t('高性价比'), bg: ")}url('/deco-save-bg.png') center/cover no-repeat{t(",
    textColor: '#0A1628', borderColor: '#C8D8E8',
    shadowHover: '0 24px 70px rgba(0,74,143,0.12)',
    sections: [
      { value: '66%', label: t('生图成本节省') },
      { value: '46%', label: t('语言模型成本节省') },
      { value: '52%', label: t('客户托管成本下降') },
    ],
  },
]
...
const IconScalability = () => (
  <svg width="65" height="64" viewBox="0 0 65 64" fill="none"><path d="M17.6602 14.0137C17.6602 19.7944 22.3463 24.4805 28.127 24.4805C33.9075 24.4803 38.5938 19.7943 38.5938 14.0137C38.5938 13.9032 38.5884 13.7932 38.585 13.6836H46.5166C48.6185 13.6837 50.322 15.3874 50.3223 17.4893V27.3018C45.2313 28.0108 41.3125 32.3798 41.3125 37.666C41.3125 42.9522 45.2313 47.3202 50.3223 48.0293V54.9297C50.3222 57.0317 48.6186 58.7353 46.5166 58.7354H38.585C38.4104 53.1077 33.7969 48.5988 28.127 48.5986C22.4569 48.5986 17.8436 53.1077 17.6689 58.7354H9.07617C6.97436 58.7351 5.27057 57.0315 5.27051 54.9297V46.998C5.38015 47.0014 5.49012 47.0068 5.60059 47.0068C11.3812 47.0068 16.0672 42.3206 16.0674 36.54C16.0674 30.7594 11.3813 26.0732 5.60059 26.0732C5.49012 26.0732 5.38015 26.0777 5.27051 26.0811V17.4893C5.27076 15.3876 6.97447 13.6838 9.07617 13.6836H17.6689C17.6655 13.7932 17.6602 13.9032 17.6602 14.0137ZM51.8555 28C57.1103 28 61.3709 32.2598 61.3711 37.5146C61.3711 42.7696 57.1105 47.0303 51.8555 47.0303C46.6006 47.0301 42.3408 42.7695 42.3408 37.5146C42.341 32.2599 46.6008 28.0002 51.8555 28Z" fill="#004A8F"/><circle cx="28.1071" cy="14.0153" r="9.51531" fill="#0080C0{t("/></svg>
)
const smallCards = [
  { title: t('高稳定性'), items: [t('经过开发者验证，保证高可靠稳定运行'), t('完善的监控和容错机制'), t('专业技术支持，满足企业级场景需求')], Icon: IconStability },
  { title: t('高智能'), items: [t('多种先进模型服务'), t('智能扩展，灵活适配业务规模'), t('智能成本分析，优化业务支持')], Icon: IconIntelligence },
  { title: t('高安全性'), items: [t('支持 BYOC 部署，保护数据隐私'), t('计算/网络/存储隔离'), t('符合行业标准与合规要求')], Icon: IconSecurity },
  { title: t('高扩展性'), items: [t('动态扩容支持弹性业务'), t('一键部署自定义模型'), t('灵活架构，支持混合云部署')], Icon: IconScalability },
]

/* ── 模型生态数据 ── */
const modelsData = [
  { logo: '/logo-deepseek.svg', name: 'DeepSeek', models: 'V4-Pro, V4-Flash, V3.2', desc: t('国产大模型标杆，旗舰推理能力') },
  { logo: '/logo-tongyi.svg', name: t('通义千问'), models: 'Qwen3-235B, Qwen-VL', desc: t('阿里云自研，多尺寸覆盖全场景') },
  { logo: '/logo-bytedance.svg', name: t('字节豆包'), models: 'Doubao-1.5-pro', desc: t('字节跳动自研，多模态能力强') },
  { logo: '/logo-zhipu.svg', name: t('智谱 AI'), models: 'GLM-5.1, GLM-5, GLM-4.7', desc: t('全模态大模型先驱，学术商业并重') },
  { logo: '/logo-kimi.png', name: t('月之暗面'), models: 'Kimi-K2.6, K2.5', desc: t('超长上下文，深度理解与推理') },
  { logo: '/logo-baidu.svg', name: t('百度文心'), models: 'ERNIE-4.5, ERNIE-Image', desc: t('百度自研，知识增强型大模型') },
  { logo: '/logo-hunyuan.svg', name: t('腾讯混元'), models: 'Hunyuan-Large', desc: t('腾讯全链路自研大语言模型') },
  { logo: '/logo-minimax.svg', name: 'MiniMax', models: 'MiniMax-M2.5', desc: t('轻量高效，高性价比之选') },
  { logo: '/logo-stepfun.svg', name: t('阶跃星辰'), models: 'Step-2-16K', desc: t('新一代推理模型，性能卓越') },
  { logo: '/logo-lingyi.png', name: t('零一万物'), models: 'Yi-Lightning, Yi-Large', desc: t('李开复创立，高速推理引擎') },
  { logo: '/logo-baichuan.svg', name: t('百川智能'), models: 'Baichuan4, Baichuan-M1', desc: t('王小川创立，医疗领域领先') },
  { logo: '/logo-baai.svg', name: t('智源研究院'), models: 'Aquila, BGE, FlagEmbedding', desc: t('非营利研究机构，开源模型先驱') },
]

/* ── 行业方案 ── */
const industryCards = [
  { title: t('互联网'), desc: t('高效智能的内容生成与个性化推荐服务，加速 AI 生成速度，优化 GPU 算力使用效率。'), img: '/industry-internet.png' },
  { title: t('教育'), desc: t('AI 驱动的个性化学习、智能批改与知识问答，助力教育数字化转型。'), img: '/industry-education.png' },
  { title: t('政务'), desc: t('智能文档处理、政策问答、数据安全保障，支撑智慧政务建设。'), img: '/industry-government.png' },
  { title: t('智算中心'), desc: t('高性能推理服务、模型部署与运维，为智算中心提供全栈 AI 算力运营。'), img: '/industry-ai-center.png' },
  { title: t('AI 硬件'), desc: t('边缘计算、端侧推理优化，赋能 AI 硬件设备智能化升级。'), img: '/industry-hardware.png' },
]
...
export function Home() {
  ...
  return (
    <PublicLayout showMainContainer={false}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '180px 32px 200px', textAlign: 'center', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Button style={{ height: 56, padding: '0 40px', fontSize: 17, fontWeight: 700, borderRadius: 16, background: '#004A8F', boxShadow: '0 8px 32px rgba(0,74,143,0.3)', border: 'none' }}
              ...
              render={<Link to="/sign-up" />}>{t("立即体验")} <ArrowRight style={{ marginLeft: 8, width: 18 }} /></Button>
            <Button variant="outline" style={{ height: 56, padding: '0 40px', fontSize: 17, fontWeight: 600, borderRadius: 16, borderColor: s.isDark ? 'rgba(255,255,255,0.25)' : '#D5D6EA', color: s.isDark ? 'rgba(255,255,255,0.9)' : '#334155', background: s.isDark ? 'rgba(255,255,255,0.06)' : '#fff' }}
              ...
              render={<Link to="/pricing" />}>{t("查看模型")}</Button>
          </div>
        </div>
      ...
      <section style={{ background: '#fff', padding: '64px 24px 80px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 20 }}>
          {perfCards.map((c, i) => (
            ...
            >
              <c.icon size={22} color="#0080C0{t(" style={{ marginBottom: 14, opacity: 0.65 }} />
      ...
      {/* ═══ SECTION 3 — 产品矩阵 3×2 ═══ */}
      <section style={{ background: '#EAF1F1', padding: '80px 24px 100px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader icon={Sparkles} badge={t("产品矩阵")} title={t("全场景 AI 能力平台")} desc={t("助力用户一站式实现 AI 能力与应用的快速对接")} />
      ...
      <section style={{ background: '#fff', padding: '100px 24px 80px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader icon={Shield} badge={t("核心优势")} title={t("为什么选择 aiburj")} desc={t("致力于成为国内领先的 AI 能力提供商")} descMaxWidth={500} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 48, margin: '56px -40px 0', padding: 0 }}>
            {smallCards.map((card, i) => (
              <div key={i} className="advantage-small-card{t(" style={{ background: '#F0F6FC', padding: '48px 32px', minHeight: 520, maxWidth: 326, position: 'relative', overflow: 'hidden', borderRadius: 8, transition: 'box-shadow 0.3s', cursor: 'default' }}
                onMouseEnter={e => {
      ...
      {/* ═══ SECTION 5 — 模型生态 3×4 ═══ */}
      <section style={{ background: '#EAF1F1', padding: '100px 24px 80px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader icon={Cpu} badge={t("模型生态")} title={t("已接入的国产大模型")} desc={t("覆盖国内主流大模型厂商，一个 API 全部调用")} />
      ...
      <section style={{ background: '#fff', padding: '100px 24px', overflow: 'hidden' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader icon={Globe} badge={t("行业方案")} title={t("面向不同行业，提供灵活的解决方案")} desc={t("覆盖互联网、教育、政务、智算中心、AI 硬件等多行业场景")} descMaxWidth={640} />
      ...
      {/* ═══ SECTION 7 — 合作伙伴 ═══ */}
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(180deg, #EAF1F1 0%, #E8F0FA 40%, #DCE8F8 70%, #EAF1F1 100%)', padding: '88px 0 0' }}>
        {/* 装饰光晕 */}
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
        <h2 style={{ fontSize: 48, fontWeight: 700, color: '#252736', textAlign: 'center', marginBottom: 66, letterSpacing: '-0.02em' }}>{t("典型客户与合作伙伴")}</h2>
      ...
      <section style={{ background: '#fff', padding: '100px 24px 80px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <SectionHeader icon={Code} badge={t("快速开始")} title={t("三步接入，零门槛")} desc={t("获取 API Key → 选择模型 → 复制代码，OpenAI SDK 直接兼容")} />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 24 }}>
            {[
              ...
              >
                ...
                <pre style={{ color: '#CDD6F4', fontSize: 13, lineHeight: 2, margin: 0, padding: '20px 22px 24px', whiteSpace: 'pre-wrap', wordBreak: 'break-all', fontFamily: "'SF Mono','Fira Code',monospace{t(", overflow: 'auto', maxHeight: 380 }}>{tab.code}</pre>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(135deg, #001A40 0%, #002060 30%, #004A8F 60%, #0080C0 100%)', padding: '110px 24px 100px', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(255,255,255,0.12)', borderRadius: 50, border: '1px solid rgba(255,255,255,0.15)', padding: '8px 24px', fontSize: 14, fontWeight: 600, color: 'rgba(255,255,255,0.9)', marginBottom: 36 }}>
            <Sparkles size={16} /> {t("限时体验")}
          </div>
          <h2 style={{ fontSize: 'clamp(34px,5vw,56px)', fontWeight: 900, color: '#fff', marginBottom: 24, lineHeight: 1.2 }}>{t("开始构建你的 AI 应用")}</h2>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 18, marginBottom: 48, lineHeight: 1.7 }}>{t("注册即享体验额度，零成本测试所有国产大模型")}</p>
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            >{t("免费注册")} <ArrowRight style={{ marginLeft: 8, width: 20 }} /></Button>
