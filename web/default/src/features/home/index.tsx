...
/* ── Hero 轮播数据 ── */
const slides = [
  { title: '国产大模型的灯塔', title2: '一站汇聚，照亮 AI 之路', desc: 'OpenAI 兼容格式，统一 API 调用 DeepSeek、通义千问、GLM 等国产大模型，按量计费，快速集成', bg: '/banner-1.png', overlay: 'linear-gradient(180deg, rgba(230,240,250,0.55) 0%, rgba(220,235,248,0.65) 50%, rgba(255,255,255,0.9) 100%)', textColor: '#252736', badge: 'AI 之塔', isDark: false, bgPos: 'right center', bgSize: 'auto 100%', blendEdge: true },
