  ...
  return (
    <PublicLayout showMainContainer={false}>
      ...
      <section
        ...
        style={{ position: 'relative', overflow: 'hidden', minHeight: '100vh', display: 'flex', alignItems: 'center', backgroundColor: '#E6F0FA', backgroundImage: `url(${s.bg})`, backgroundPosition: s.bgPos, backgroundSize: s.bgSize, backgroundRepeat: 'no-repeat', transition: 'background 0.8s ease' }}
      >
