	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				// Ticket routes
				selfRoute.POST("/ticket", controller.SubmitTicket)
				selfRoute.GET("/ticket", controller.GetMyTickets)
			...
			adminRoute.GET("/:id/detail", controller.AdminGetUserDetail)
				...
				// Admin ticket routes
				adminRoute.GET("/tickets", controller.AdminListTickets)
				adminRoute.PUT("/tickets", controller.AdminUpdateTicket)
